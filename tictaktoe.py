...
def chek_winner(list):
    result = ['123', '159', '456', '357', '963', '789', '741']
    for i in result:
        cc = 0
        for j in list:
            if j in i:
...
def play():
    ...
    while True:
        name['player1']=input('Hey player1 Enter your first name:')
        if name['player1']!='':
            break
        else :
            print("Please reenter your name!")
    while True:
        name['player2']=input('Hey player2 Enter your first name:')
        if name['player2']!='':
            break
        else :
            print("Please reenter your name!")
    ...
    while done!=True:
        ...
        if n==1:
            print('{} is going to start'.format(name['player1']))
            while True:
                XO1 = input('Chose between X or Y:')  
                if XO1.upper()=='X' or XO1.upper()=='Y':
                    break
                else :
                    print( name['player1']+" Please choose between X and Y!")
            ...
            print('{} is going to start'.format(name['player2']))
            ...
            while True:
                ...
                if  XO2.upper()=='X' or  XO2.upper()=='Y':
                    ...
                    print(name['player2']+" Please choose between X and Y!")
        ...
        answer =input('If you want to continue playing type YES else type NO ')
        if answer.upper()=='YES':
            print("Lets go again...")
        else : 
            done=True 
